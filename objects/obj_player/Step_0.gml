...
depth = -y
k_a = keyboard_check(ord("A"))or keyboard_check(vk_left)
k_d = keyboard_check(ord("D"))or keyboard_check(vk_right)
k_w = keyboard_check(ord("W"))or keyboard_check(vk_up)
k_s = keyboard_check(ord("S"))or keyboard_check(vk_down)
